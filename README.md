...
**DISCLAIMER:**
Install it at your own responsability. **This firmware is ONLY for A12 and A13 all versions (except IPS which is not supported)**, installing in other devices will cause a half brick and you will need to use tools that are not available here.
 ...
 * Flash the firmware with: ```sudo Linux_Upgrade_Tool_v1.49/upgrade_tool uf RUKA_a12_v1_v2_3.0_alpha_20210504.img```
